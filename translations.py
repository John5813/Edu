TRANSLATIONS = {
    ...
    "uz": {
        ...
        "enter_section_title": "📝 {section_num}/{total_sections} - bo'lim sarlavhasini kiriting:",
        "enter_slide_title": "📝 {slide_num}/{total_slides} - slayd uchun kalit so'z kiriting:",
        "manual_outline_instruction_presentation": "📋 Siz {total_slides} ta slayd uchun kalit so'zlarni kiritishingiz kerak.\n\n💡 Har bir slayd uchun bitta kalit so'z yoki qisqa ibora kiriting.",
        "manual_outline_instruction_document": "📋 Tanlangan varoq hajmi uchun {total_sections} ta bo'lim sarlavhasi kiritishingiz kerak.\n\n💡 Har bir bo'lim uchun aniq va tushunarli sarlavha kiriting.",
...
👆 **Quyidagi raqamlardan birini bosing:**""",
    ...
    "ru": {
        ...
        "enter_section_title": "📝 {section_num}/{total_sections} - введите заголовок раздела:",
        "enter_slide_title": "📝 {slide_num}/{total_slides} - введите ключевое слово для слайда:",
        "manual_outline_instruction_presentation": "📋 Вам нужно ввести ключевые слова для {total_slides} слайдов.\n\n💡 Введите одно ключевое слово или короткую фразу для каждого слайда.",
        "manual_outline_instruction_document": "📋 Для выбранного объема страниц вам нужно ввести {total_sections} названий разделов.\n\n💡 Введите четкий и понятный заголовок для каждого раздела.",
...
👆 **Нажмите одну из цифр ниже:**""",
    ...
    "en": {
        ...
        "enter_section_title": "📝 {section_num}/{total_sections} - enter section title:",
        "enter_slide_title": "📝 {slide_num}/{total_slides} - enter keyword for slide:",
        "manual_outline_instruction_presentation": "📋 You need to enter keywords for {total_slides} slides.\n\n💡 Enter one keyword or short phrase for each slide.",
        "manual_outline_instruction_document": "📋 For the selected page count, you need to enter {total_sections} section titles.\n\n💡 Enter a clear and understandable title for each section.",
