TRANSLATIONS = {
    "uz": {
        ...
        "help_text": "🆘 Yordam\n\n📊 Taqdimot - AI yordamida taqdimot yaratish\n🎓 Mustaqil ish - DOCX formatda mustaqil ish\n📄 Referat - DOCX formatda referat\n💰 Hisobim - balans va bepul xizmatlar\n💳 To'lov - mablag' to'ldirish\n⚙️ Sozlamalar - tilni o'zgartirish",
    ...
    "ru": {
        ...
        "help_text": "🆘 Помощь\n\n📊 Презентация - создание презентации с помощью ИИ\n🎓 Самостоятельная работа - создание работы в формате DOCX\n📄 Реферат - создание реферата в формате DOCX\n💰 Мой счет - баланс и бесплатные услуги\n💳 Оплата - пополнение баланса\n⚙️ Настройки - изменение языка",
    ...
    "en": {
        ...
        "help_text": "🆘 Help\n\n📊 Presentation - create AI-powered presentations\n🎓 Independent Work - create work in DOCX format\n📄 Research Paper - create paper in DOCX format\n💰 My Account - balance and free services\n💳 Payment - top up balance\n⚙️ Settings - change language",
