...
def get_course_work_page_keyboard(language: str = "uz") -> InlineKeyboardMarkup:
    ...
    if language == "uz":
        ...
        keyboard.add(InlineKeyboardButton(text="40-50 varoq (4 bo'lim) - 40000 so'm", callback_data="cw_pages_40_50_4"))
        keyboard.add(InlineKeyboardButton(text="50-60 varoq (4 bo'lim) - 50000 so'm", callback_data="cw_pages_50_60_4"))
    elif language == "ru":
        ...
        keyboard.add(InlineKeyboardButton(text="40-50 стр (4 главы) - 40000 сум", callback_data="cw_pages_40_50_4"))
        keyboard.add(InlineKeyboardButton(text="50-60 стр (4 главы) - 50000 сум", callback_data="cw_pages_50_60_4"))
    else:
        ...
        keyboard.add(InlineKeyboardButton(text="40-50 pages (4 chapters) - 40000 som", callback_data="cw_pages_40_50_4"))
        keyboard.add(InlineKeyboardButton(text="50-60 pages (4 chapters) - 50000 som", callback_data="cw_pages_50_60_4"))
