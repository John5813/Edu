...
def get_test_source_keyboard(language: str = "uz") -> InlineKeyboardMarkup:
    """Choose whether tests are generated from a topic or an uploaded file."""
    keyboard = InlineKeyboardBuilder()
    labels = {
        "uz": ("🤖 AI orqali", "📎 Fayl orqali"),
        "ru": ("🤖 Через AI", "📎 Из файла"),
        "en": ("🤖 With AI", "📎 From a file"),
    }
    ai_label, file_label = labels.get(language, labels["uz"])
    keyboard.add(InlineKeyboardButton(text=ai_label, callback_data="test_source_ai"))
    keyboard.add(InlineKeyboardButton(text=file_label, callback_data="test_source_file"))
    keyboard.add(InlineKeyboardButton(text=_back_text(language), callback_data="os:back"))
    keyboard.adjust(1)
    return keyboard.as_markup()


def get_test_file_source_keyboard(language: str = "uz") -> InlineKeyboardMarkup:
    """Choose the supported uploaded-test mode or the future book mode."""
    keyboard = InlineKeyboardBuilder()
    labels = {
        "uz": ("📝 Ichida faqat testlar bor fayl", "📚 Kitob asosida (tez orada)"),
        "ru": ("📝 Файл только с тестами", "📚 На основе книги (скоро)"),
        "en": ("📝 File containing only tests", "📚 Based on a book (soon)"),
    }
    tests_label, book_label = labels.get(language, labels["uz"])
    keyboard.add(InlineKeyboardButton(text=tests_label, callback_data="test_file_tests"))
    keyboard.add(InlineKeyboardButton(text=book_label, callback_data="test_file_book"))
    keyboard.add(InlineKeyboardButton(text=_back_text(language), callback_data="test_source_back"))
    keyboard.adjust(1)
    return keyboard.as_markup()
...
def get_course_work_page_keyboard(language: str = "uz") -> InlineKeyboardMarkup:
    ...
    if language == "uz":
        ...
        keyboard.add(InlineKeyboardButton(text="40-50 varoq (4 bo'lim) - 30000 so'm", callback_data="cw_pages_40_50_4"))
        keyboard.add(InlineKeyboardButton(text="50-60 varoq (4 bo'lim) - 35000 so'm", callback_data="cw_pages_50_60_4"))
    elif language == "ru":
        ...
        keyboard.add(InlineKeyboardButton(text="40-50 стр (4 главы) - 30000 сум", callback_data="cw_pages_40_50_4"))
        keyboard.add(InlineKeyboardButton(text="50-60 стр (4 главы) - 35000 сум", callback_data="cw_pages_50_60_4"))
    else:
        ...
        keyboard.add(InlineKeyboardButton(text="40-50 pages (4 chapters) - 30000 som", callback_data="cw_pages_40_50_4"))
        keyboard.add(InlineKeyboardButton(text="50-60 pages (4 chapters) - 35000 som", callback_data="cw_pages_50_60_4"))
