"""OpenAI yordamida python-pptx source code generatori.
...
def generate_presentation_code(
    ...
    """OpenAI'dan to‘liq kod oladi yoki xato berilgan kodni qayta tuzatadi."""
...
"""
    ...
    if not code:
        raise RuntimeError("OpenAI bo‘sh kod qaytardi")
